...
public class Snake : MonoBehaviour
{
    ...
    void Start() {
        ...
        // movement control
        inputHandler.AssignCommand(new UpCommand(this), InputHandler.getKey(Commands.UpCommand));
        inputHandler.AssignCommand(new RightCommand(this), InputHandler.getKey(Commands.RightCommand));
        inputHandler.AssignCommand(new DownCommand(this), InputHandler.getKey(Commands.DownCommand));
        inputHandler.AssignCommand(new LeftCommand(this), InputHandler.getKey(Commands.LeftCommand));
